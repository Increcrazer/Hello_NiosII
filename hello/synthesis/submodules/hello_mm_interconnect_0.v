...
module hello_mm_interconnect_0 (
	...
	wire  [18:0] cpu_0_data_master_translator_avalon_universal_master_0_address;              // cpu_0_data_master_translator:uav_address -> cpu_0_data_master_agent:av_address
	...
	wire   [2:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> cpu_0_data_master_agent:rp_channel
	...
	wire  [18:0] cpu_0_instruction_master_translator_avalon_universal_master_0_address;       // cpu_0_instruction_master_translator:uav_address -> cpu_0_instruction_master_agent:av_address
	...
	wire   [2:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> cpu_0_instruction_master_agent:rp_channel
	...
	wire  [18:0] cpu_0_jtag_debug_module_agent_m0_address;                                    // cpu_0_jtag_debug_module_agent:m0_address -> cpu_0_jtag_debug_module_translator:uav_address
	...
	wire  [92:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> cpu_0_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // cpu_0_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> cpu_0_jtag_debug_module_agent:cp_channel
	...
	wire  [92:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire  [92:0] cpu_0_jtag_debug_module_agent_rp_data;                                       // cpu_0_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [92:0] onchip_memory2_s1_agent_rp_data;                                             // onchip_memory2_s1_agent:rp_data -> router_004:sink_data
	...
	wire         cpu_0_jtag_debug_module_agent_rdata_fifo_src_valid;                          // cpu_0_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] cpu_0_jtag_debug_module_agent_rdata_fifo_src_data;                           // cpu_0_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         cpu_0_jtag_debug_module_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_001:in_0_ready -> cpu_0_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                           // avalon_st_adapter_001:out_0_valid -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                            // avalon_st_adapter_001:out_0_data -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                           // cpu_0_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                           // avalon_st_adapter_001:out_0_error -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_error
	...
	hello_mm_interconnect_0_router router_001 (
	...
	hello_mm_interconnect_0_router_002 router_004 (
	...
	hello_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
